...
class Detail extends Component
{
    ...
    public $ids, $bank_soal, $selectedJenis = '1', $ditampilkan, $seharusnya;
    ...
    {
        $total_tampil_pg = Soal::where([
            ['id_bank', $this->ids],
            ['jenis', $this->selectedJenis],
            ['tampilkan', '1'],
        ])->count();

        $this->ditampilkan = $total_tampil_pg;
    }
    ...
    public function render()
    {
        ...
        return view('livewire.ujian.bank-soal.detail', compact('data', 'total_dibuat', 'seluruh_total_dibuat', 'ditampilkan'));
    }
