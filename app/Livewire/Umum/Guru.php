...
class Guru extends Component
{
    ...
    public function render()
    {
        ...
        $data = ModelsGuru::select('guru.id', 'guru.nama_guru', 'guru.nip', 'level_guru.level as nama_level', 'kelas1.kode_kelas as walikelas', 'kelas2.kode_kelas as kelas_ngajar', 'mata_pelajaran.nama_mapel')
        ...
        $kelas  = Kelas::select('id', 'kode_kelas')->get();
    ...
    {
        ModelsGuru::findOrFail($this->dataId)->delete();
