                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-header">
                            <div class="flex">
                                <div>
                                    <img src="https://www.svgrepo.com/show/335455/profile-default.svg" alt=""
                        ...
                        <div class="collapse px-4 pb-3 pt-2" id="mycard-collapse-{{ $loop->index }}" wire:ignore.self>
                            ...
                            @foreach ($data->where('id', $row[0]['id'])->groupBy('nama_mapel') as $mapel =>
                            $groupedData)
                            <div class="mt-3">
                        ...
                        <ul class="nav nav-pills" id="myTab3" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="profile-tab" data-toggle="tab" href="#profile" role="tab"
                                    aria-controls="home" aria-selected="true" wire:ignore.self>Profile</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="data-lengkap-tab" data-toggle="tab" href="#data-lengkap"
                                    role="tab" aria-controls="profile" aria-selected="false" wire:ignore.self>Data
                                    Lengkap</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="jabatan-tab" data-toggle="tab" href="#jabatan" role="tab"
                                    aria-controls="contact" aria-selected="false" wire:ignore.self>Jabatan</a>
                            </li>
                        </ul>
                            ...
                            <div class="tab-pane fade" id="data-lengkap" role="tabpanel"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea wire:model="alamat" id="alamat" class="form-control"
                                        style="height: 70px !important;"></textarea>
                                </div>
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div wire:ignore>
                                        <select wire:model="id_mapel_kelas.{{ $mapel->id }}"
                                            id="id_mapel_kelas_{{ $mapel->id }}" class="form-control" multiple>
                                            @foreach ($kelas as $level => $kelasGroup)
                                            <optgroup label="{{ $level }}">
                                                @foreach ($kelasGroup as $kelasItem)
                                                <option value="{{ $kelasItem->id }}">
