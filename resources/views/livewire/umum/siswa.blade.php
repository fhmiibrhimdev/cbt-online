                                    ...
                                    <td class="text-center">
                                        <div class="progress">
                                            <div class="progress-bar" role="progressbar"
                                                ...
                                                aria-valuenow="{{ $row->getCompletionPercentage() }}" aria-valuemin="0"
                                                aria-valuemax="100"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select wire:model="kelas" id="kelas" class="form-control">
                                                <option value="" disabled>-- Opsi Pilihan--</option>
                                                @for ($i = 1; $i <= 13; $i++) <option value="{{ $i }}">Kelas {{ $i }}
                                                    </option>
                                                    @endfor
                                            </select>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <textarea wire:model="alamat_ayah" id="alamat_ayah" class="form-control"
                                                style="height: 100px !important;"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <textarea wire:model="alamat_ibu" id="alamat_ibu" class="form-control"
                                                style="height: 100px !important;"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                            ...
                            <div class="tab-pane fade" id="wali" role="tabpanel" aria-labelledby="wali-tab">
                                <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea wire:model="alamat_wali" id="alamat_wali" class="form-control"
                                            style="height: 100px !important;"></textarea>
                                    </div>
                                    <div class="form-group">
