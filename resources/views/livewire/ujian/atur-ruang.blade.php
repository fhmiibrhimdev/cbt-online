                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div wire:ignore>
                                            <select wire:model="data.{{ $siswa->id }}.id_ruang" id="id_ruang_{{ $siswa->id }}" class="form-control">
                                    ...
                                    <td>
                                        <div wire:ignore>
                                            <select wire:model="data.{{ $siswa->id }}.id_sesi" id="id_sesi_{{ $siswa->id }}" class="form-control">
