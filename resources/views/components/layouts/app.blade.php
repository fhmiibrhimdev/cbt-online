...
<body class="layout-3" style="font-family: 'Inter', sans-serif">
    <div id="app">
        <div class="main-wrapper container">
            <div class="navbar-bg" style="background-image: url('{{ asset('assets/background-cbt.png') }}'); background-size: cover;"></div>
            <nav class="navbar navbar-expand-lg main-navbar">
                <a href="{{ url('dashboard') }}" class="navbar-brand sidebar-gone-hide">CBT Online</a>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown 
                            ...
                            <ul class="dropdown-menu">
                                <li class="nav-item {{ request()->is('umum/tahun-pelajaran') ? 'active' : '' }}">
                                    <a href="{{ url('/umum/tahun-pelajaran') }}" class="nav-link">Tahun Pelajaran</a>
                                </li>
                                ...
                                <li class="nav-item {{ request()->is('umum/ekstrakurikuler') ? 'active' : '' }}">
                                    <a href="{{ url('/umum/ekstrakurikuler') }}" class="nav-link">Ekstrakurikuler</a>
                                </li>
                        ...
                        <li class="nav-item dropdown 
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="nav-item {{ request()->is('ujian/atur-ruang') || str_contains(request()->path(), 'ujian/atur-ruang') ? 'active' : '' }}">
                                    <a href="{{ url('ujian/atur-ruang') }}" class="nav-link">Atur Ruang / Sesi</a>
                                </li>
                                <li class="nav-item {{ request()->is('ujian/nomor-peserta') ? 'active' : '' }}">
                                    <a href="{{ url('ujian/nomor-peserta') }}" class="nav-link">Nomor Peserta</a>
                                </li>
                                <li class="nav-item {{ request()->is('ujian/bank-soal') ? 'active' : '' }}">
                        ...
                        <li class="nav-item dropdown 
                            {{ request()->is('pelaksanaan-ujian/cetak') || request()->is('pelaksanaan-ujian/status-siswa') || request()->is('pelaksanaan-ujian/hasil-ujian') || request()->is('pelaksanaan-ujian/analisis-soal') || request()->is('pelaksanaan-ujian/rekap') ? 'active' : '' }}">
                            <a href="#" data-toggle="dropdown" class="nav-link has-dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('pelaksanaan-ujian/status-siswa') }}" class="nav-link">Status Siswa</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('pelaksanaan-ujian/hasil-ujian') }}" class="nav-link">Hasil Ujian</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('pelaksanaan-ujian/analisis-soal') }}" class="nav-link">Analisis Soal</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <li class="nav-item dropdown 
                            {{ request()->is('pengaturan/setting-raport') || request()->is('pengaturan/profile-sekolah') || request()->is('pengaturan/administrator') || request()->is('pengaturan/guru') || request()->is('pengaturan/siswa') ? 'active' : '' }}">
                            <a href="#" data-toggle="dropdown" class="nav-link has-dropdown">
                                <i class="far fa-cogs"></i><span>Pengaturan</span>
                            </a>
                            <ul class="dropdown-menu">
                                <li class="nav-item">
                                    <a href="{{ url('pengaturan/setting-raport') }}" class="nav-link">Setting Raport</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('pengaturan/profile-sekolah') }}" class="nav-link">Profile Sekolah</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('pengaturan/administrator') }}" class="nav-link">Administrator</a>
                                </li>
                                <li class="nav-item">
